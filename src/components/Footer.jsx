  ...
  return (
    <footer className="relative bg-gradient-to-t from-gray-800 via-gray-900 to-gray-800 text-gray-300 py-12 px-5 md:px-10 flex flex-col items-center justify-center shadow-2xl space-y-10 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="water-background animate-flow"></div>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center space-y-6 mb-8">
        {/* Email */}
        <div className="flex items-center space-x-4 text-gray-400 hover:text-white transition-all duration-300 ease-in-out">
          <Mail className="w-6 h-6" />
          <a href="mailto:abbasomerhassn@gmail.com" className="text-lg underline hover:underline-offset-4">
        ...
        <div className="flex items-center space-x-4 text-gray-400 hover:text-white transition-all duration-300 ease-in-out">
          ...
          <a href="tel:0794294091" className="text-lg underline hover:underline-offset-4">
            07 94294091
          </a>
        </div>
      </div>
