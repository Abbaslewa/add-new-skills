  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full sm:w-1/2 flex justify-center items-center">
        <form className="flex flex-col space-y-4 w-[80%] sm:w-[65%] lg:w-[70%] p-6 sm:p-8 rounded-2xl shadow-lg transition-shadow duration-500 ease-in-out backdrop-blur-md bg-gray-900 border border-white/20">
          ...
          <button
            type="submit"
            className=" border border-gray-700  p-2 sm:p-3 rounded-lg w-full text-sm sm:text-md font-semibold text-white transition-colors duration-300 ease-in-out focus:ring-4 focus:ring-green-600 shadow-lg hover:shadow-xl "
          >
            Submit
          </button>
        </form>
